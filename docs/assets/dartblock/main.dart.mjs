...
class CompiledApp {
  ...
  async instantiate(additionalImports, {loadDeferredWasm, loadDynamicModule} = {}) {
    ...
    const dart2wasm = {
      ...
      _1378: x0 => x0.click(),
      _1379: x0 => new Blob(x0),
      _1380: x0 => globalThis.URL.revokeObjectURL(x0),
      _1385: Date.now,
      ...
      _1463: (t, s) => t.set(s),
      _1464: l => new DataView(new ArrayBuffer(l)),
      ...
      _1599: x0 => x0.read(),
      _1600: x0 => x0.random(),
      _1601: (x0,x1) => x0.getRandomValues(x1),
      _1602: () => globalThis.crypto,
      _1603: () => globalThis.Math,
